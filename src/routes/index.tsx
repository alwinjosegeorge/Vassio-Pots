...
function Index() {
  ...
  return (
    <Layout>
      ...
      {/* Editorial blocks */}
      <section className="bg-secondary/20 border-t border-border/30">
        <div className="mx-auto max-w-[1400px]">
          {/* Block 1 */}
          <div className="grid grid-cols-1 md:grid-cols-2 items-center border-b border-border/30">
            <div className="px-8 py-16 md:px-20 md:py-24">
              <p className="text-xs uppercase tracking-[0.4em] text-muted-foreground">
                Styling Tips
              </p>
              <h2 className="serif mt-4 text-3xl md:text-5xl leading-tight text-foreground">
                Styling the Plant
              </h2>
              <p className="mt-5 text-sm leading-relaxed text-muted-foreground/90 max-w-md">
                Learn how to choose the right planter size, pair materials with your interior
                palette, and arrange the foliage to create a striking natural statement.
              </p>
              <a
                href="#"
                className="mt-8 inline-block bg-accent text-accent-foreground px-8 py-3.5 text-xs uppercase tracking-[0.25em] font-semibold hover:bg-accent/90 transition duration-300 rounded"
              >
                View Products
              </a>
            </div>
          ...
          {/* Block 2 */}
          <div className="grid grid-cols-1 md:grid-cols-2 items-center border-b border-border/30">
            <div className="aspect-[4/3] md:aspect-auto h-full w-full overflow-hidden order-2 md:order-1">
              <img
                src={livingRoomVases}
                alt="Decorate with vases"
                loading="lazy"
                className="h-full w-full object-cover transition duration-700 hover:scale-105"
              />
            </div>
            <div className="px-8 py-16 md:px-20 md:py-24 order-1 md:order-2">
              <p className="text-xs uppercase tracking-[0.4em] text-muted-foreground">
                Living Room Edit
              </p>
              <h2 className="serif mt-4 text-3xl md:text-5xl leading-tight text-foreground">
              ...
              <p className="mt-5 text-sm leading-relaxed text-muted-foreground/90 max-w-md">
                Elevate your coffee tables, shelves, and entryways with our organic, textured
                ceramic vessels. Designed to add quiet beauty and architectural structure.
              </p>
              <a
                href="#"
                className="mt-8 inline-block bg-accent text-accent-foreground px-8 py-3.5 text-xs uppercase tracking-[0.25em] font-semibold hover:bg-accent/90 transition duration-300 rounded"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center border-b border-border/30">
            <div className="px-8 py-16 md:px-20 md:py-24">
              ...
              <h2 className="serif mt-4 text-3xl md:text-5xl leading-tight text-foreground">
                Experience the Calming Aromas
              </h2>
              <p className="mt-5 text-sm leading-relaxed text-muted-foreground/90 max-w-md">
                Introduce restorative fragrance notes of lavender, amber, and cedar wood. Complete
                with modern ceramic soap and incense accessories.
              </p>
              <a
                href="#"
                className="mt-8 inline-block bg-accent text-accent-foreground px-8 py-3.5 text-xs uppercase tracking-[0.25em] font-semibold hover:bg-accent/90 transition duration-300 rounded"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center">
            ...
            <div className="px-8 py-16 md:px-20 md:py-24 order-1 md:order-2">
              ...
              <p className="mt-5 text-sm leading-relaxed text-muted-foreground/90 max-w-md">
                A final opportunity to secure our most loved styling elements. Once they're gone,
                they're gone — refresh your home with timeless details.
              </p>
              <a
                href="#"
                className="mt-8 inline-block bg-accent text-accent-foreground px-8 py-3.5 text-xs uppercase tracking-[0.25em] font-semibold hover:bg-accent/90 transition duration-300 rounded"
