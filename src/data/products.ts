...
export const categories = [
  { name: "Vases", img: catDecor },
  { name: "Planters & Pots", img: catFurniture },
  { name: "Decoratives", img: catBedding },
  { name: "Aromas", img: catKitchen },
  { name: "Lamps & Lighting", img: catBath },
];
...
export const vases = [
  {
    ...
    pairsWith: { code: "DSV2299", name: "Dune Stoneware Vase", price: 1499, mrp: 2299, img: prod1 },
  },
  {
    name: "Dune Stoneware Vase",
    price: 1499,
  ...
  },
  {
    ...
    pairsWith: { code: "LRB2799", name: "Loom Rattan Basket", price: 1899, mrp: 2799, img: prod4 },
  },
  {
    ...
    description:
      "Woven by hand using traditional techniques, this rattan basket is the perfect outer cover for your plastic starter pots or as a stylish organic storage solution.",
    pairsWith: { code: "HMB4999", name: "Halo Marble Bowl", price: 3499, mrp: 4999, img: prod2 },
  },
];
